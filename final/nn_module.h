...
int inference6(const float *A1,const float *A2,const float *A3, const float *b1,  const float *b2, const float *b3,float a1,float a2, const float *x,float * y);  //6層による推論を行い、得られた結果[0:9]を返す
...
void prelu_bwd(int n, const float * x, const float * dEdy, float * dEdx,float a, float *dEda);  //preluの逆誤差伝播を行う
...
void backward6(const float *A1,const float *A2,const float *A3, const float *b1,  const float *b2, const float *b3,float a1,float a2, const float *x, unsigned char t, float *y,
    float *dEdA1,float *dEdA2,float *dEdA3, float *dEdb1,float *dEdb2,float *dEdb3,float * dEda1,float  *dEda2);  //6層の逆誤差伝播を行う
